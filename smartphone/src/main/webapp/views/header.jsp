...
<title>online Smartphone World site</title>
</head>
<body>
<center><h1></h1>
<p>The site you can get your favourite smartphone product.</p></center>
<nav class="navbar navbar-inverse ">
  <div class="container-fluid">
    ...
    <a href="index" class="pull-left"><img src="https://cmkt-image-prd.global.ssl.fastly.net/0.1.0/ps/564985/580/386/m1/fpnw/wm0/1-.jpg?1436816495&s=36d5eceba23d9355349d47697d8069b3" width="70" height="50"></a>
     <div class="navbar-brand">Smartphone World</div>
    </div>
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown">
		...
		<li><a href="categoryDropdown/${category.id}">${category.name}</a></li>
          ...
          <!-- <li><a href="Brands">  *Samsung
                                         *Micromax
                                         *Lenovo
                                         *Intex
                                         *Oppo
                                         *Vivo etc...</a></li>
          <li><a href="Price filters"> price range for smartphone product </a></li>
          <li><a href="Current offers">current offers of your selected brand </a></li>
	    -->
        </ul>
      </li>
