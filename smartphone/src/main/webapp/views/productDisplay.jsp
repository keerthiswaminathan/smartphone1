...
<!-- Page Content -->
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <p class="lead">SMARTPHONE WORLD</p>
                <div class="list-group">
                    <a href="categoryDropdown/101" class="list-group-item">Brands</a>
                    <a href="categoryDropdown/102" class="list-group-item">Price filters</a>
                    <a href="categoryDropdown/103" class="list-group-item">Current offers</a>
                </div>
            </div>
   <div class="col-md-9">
...
<a href="categoryback"><button type="button" class="btn btn-primary" >back to categories</button></a>
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
     ...
     $scope.refreshCartItems = function () {
         $http.get('http://localhost:8080/smartphoneworld/refreshCart/'+$scope.cartId).success(function (data) {
            $scope.cart=data;
         });
     };
