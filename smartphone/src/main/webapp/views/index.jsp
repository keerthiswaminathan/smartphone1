  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR93KCbacLKv6YVKztJ_wjG1ZrIlA2ziBi0k4gd8YAwVolvGMb4" alt="book" width="450 pixel" height="400 pixel">
      </div>

      <div class="item">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgBZOCXOyYnlpyMiJu6bEvu9iWjj5zPZLYoGdRdSoyc_7HLh-C" alt="book" width="450 pixel" height="400 pixel">
      </div>
    
      <div class="item">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQk_lIxpfUKLRYY5E60KnyPsoIMh6d1LmaVJX1BhS10HzcJ_ZQi" alt="book" width="450 pixel" height="400 pixel">
      </div>

      <div class="item">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRwchvlGU10ImNym2BkNRD5A7HSHfNSHU7xd9YpsAan69IagcI9" alt="book" width="450 pixel" height="400 pixel">
      </div>
    </div>
...
<center><h3>The Feature of online shopping.</h3> 
<p>Experience better shopping everyday from our site.</p></center>
<!-- Wrap the rest of the page in another container to center all the content. -->
    ...
    <div class="container marketing">
      ...
      <div class="w">
        <div class="col-lg-4">
          <img class="img-circle" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSK809BjV7-IA2OZbCqd2x_RUMz91uWho5Oev3m5kLUjQ3vN3bafQ" alt="Generic placeholder image" width="140" height="140">
          <h2>Brands</h2>
          <p>Choose your favourite brand:*Samsung
                                         *Micromax
                                         *Lenovo
                                         *Intex
                                         *Oppo
      ...
      <!--     <p><a class="btn btn-default" href="#" role="button">View details</a></p> -->
        ...
        <div class="col-lg-4">
          <img class="img-circle" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgghctotbdwnBJILhmSAzRxDnXTMHIn6iEQYVHmVSqHDZDMAt7" alt="Generic placeholder image" width="140" 

height="140">
          <h2>Price filters</h2>
          <p>In this category you can find out the different price ranges of your smartphone product according to your affordable price.</p>
        ...
        <div class="col-lg-4">
          ...
          <p>In this category you can find out the current offers of smartphone product according to different brands</p>
         <!--  <p><a class="btn btn-default" href="#" role="button">View details &raquo;</a></p> -->
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
      ...
      <div class="rowe">
        <div class="col-md-7">
          <h2 class="featurette-heading">Smartphone <span class="text-muted">It'll blow your mind.</span></h2>
          <p class="lead">Escape into the magical world of smartphones & gadgets. Let your imagination run wild with adventurous tales. Embark on fun-filled journeys to places that 
exist only in fiction.. Expand your knowledge in technology.</p>
        </div>
        <div class="col-md-5">
      ...
      <div class="rowe">
        <div class="col-md-7 col-md-push-5">
          ...
          <p class="lead">Better World  uses the power of various technologies & applications to change the world. We collect and sell smartphone products on online to buy & also sell smartphones. 
...
environmental value for all our stakeholders.</p>
      ...
      <div class="rowe">
        <div class="col-md-7">
          ...
          <p class="lead">All smartphone products are available with free shipping worldwide. And in case you're concerned about your eco-footprint, every order shipped from 
